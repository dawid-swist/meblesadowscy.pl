...
module.exports = function(app) {
  ...
  var testJsonProductsRouter = express.Router();

  testJsonProductsRouter.get('/', function(req, res) {
    res.send({
      'test/json/products': {
  ...
  testJsonProductsRouter.post('/', function(req, res) {
    res.status(201).end();
  });

  testJsonProductsRouter.get('/:id', function(req, res) {
    res.send({
      'test/json/products': {
        id: req.params.id
      }
  ...
  testJsonProductsRouter.put('/:id', function(req, res) {
    res.send({
      'test/json/products': {
        id: req.params.id
      }
  ...
  testJsonProductsRouter.delete('/:id', function(req, res) {
    res.status(204).end();
  });
  ...
  //
  //app.use('/api/test-json-products', require('body-parser'));
  app.use('/api/test-json-products', testJsonProductsRouter);
};
